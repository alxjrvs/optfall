 ...
 *
 * `docs/ROADMAP.md` Phase 6 — off Astro — is where the two decisions this file
 * implements were settled, and they were settled up front because they are
 * cheap now and expensive later. Both are constraints rather than preferences,
 * so they are restated here where the code is.
 *

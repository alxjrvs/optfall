...
>
  ...
  -->
  {#snippet hint()}
    <code>dominate</code> searches the text · <code>cr:dominate</code> names the corpus · <code>8.3.4b</code> goes straight to that section — <a href="/search">card operators</a> are answered on the card search.
  {/snippet}
</SearchField>
